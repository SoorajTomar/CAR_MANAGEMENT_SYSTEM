...
void mainmenu()
{
	...
	int choice;
	gotoxy(20, 3);
	printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 MAIN MENU \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
	gotoxy(20, 5);
...
void searchcars()
{
	...
	case '1':
	{
		...
		while (fread(&a, sizeof(a), 1, fp) == 1)
		{
			if (a.plate == d)
			{
				...
				printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
				gotoxy(20, 9);
				printf("\xB2 Plate #: %d", a.plate); gotoxy(47, 9); printf("\xB2");
				gotoxy(20, 10);
				printf("\xB2 Company: %s", a.company); gotoxy(47, 10); printf("\xB2");
				gotoxy(20, 11);
				printf("\xB2 Make & Model: %s ", a.make_model); gotoxy(47, 11); printf("\xB2");
				gotoxy(20, 12);
				printf("\xB2 Chassis #: %s ", a.chasis); gotoxy(47, 12); printf("\xB2"); gotoxy(47, 11); printf("\xB2");
				gotoxy(20, 13);
				printf("\xB2 Engine #: %s", a.engine); gotoxy(47, 13); printf("\xB2");
				gotoxy(20, 14);
				printf("\xB2 Availability: %s ", a.avail); gotoxy(47, 14); printf("\xB2");
				gotoxy(20, 15);
				printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
				printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
				findcar = 't';
		...
		if (findcar != 't')  //checks whether conditiion enters inside loop or not
		{
			gotoxy(20, 8);
	...
	case '2':
	{
		...
		while (fread(&a, sizeof(a), 1, fp) == 1)
		{
			if (strcmp(a.company, (s)) == 0) //checks whether a.name is equal to s or not
			{
				gotoxy(20, 7);
				printf("Search results ");
				gotoxy(3, 8);
				printf("Plate #     Company    Make & Model         Chassis #       Engine #     Availability   ");
				gotoxy(3, j);
				printf("%d", a.plate);
				gotoxy(15, j);
				printf("%s", a.company);
	...
	while (another == 'y')
	{
		...
		while (fread(&a, sizeof(a), 1, fp) == 1)
		{
			if (checkplate(d) == 0)
			{
				...
				printf("Engine #: %s", a.engine);
				gotoxy(15, 13);
				printf("Update availability info: "); scanf("%s", &a.avail);
				gotoxy(15, 16);
